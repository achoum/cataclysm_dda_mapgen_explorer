...
import cataclysm_dda_prefab_explorer.Config;
...
public class Resources {
	...
	public static PaletteTempates palette_templates;
	public static Random random = new Random();

	static ImageIcon getIcon(String filename) {
		String path = "cataclysm_dda_prefab_explorer/resources/" + filename;
	...
	public static void static_init(String main_directory) throws Exception {
		...
		palette_templates = new PaletteTempates();
		palette_templates
